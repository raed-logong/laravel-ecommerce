    ...
    <div class="products-section container">
        ...
        <div class="my-profile">
            <div class="products-header flex">
                ...
                <img src="{{productImage($user->profile->image)}} "  width="300" height="300">
                <h3 class="pr-3" ></h3>
            </div>
            <br><br>
            <div>
                <form action="{{ route('users.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input id="email" type="text" name="address" value="{{ old('email', $user->profile->address) }}" placeholder="address" required>
                    </div>
                    <div class="form-group">
                        <textarea id="email" type="text" name="description" value="{{ old('email', $user->profile->address) }}"
